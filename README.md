...
Light Dose Task-1 Ubuntu Commands

I started off by using the ubuntu documentation to revise the basic commands
of Linux and since I am on a mac I directly used the terminal to put those to use.
...
Medium Dose Task-5 Manipulator Wear Cost
